"".swap STEXT nosplit size=47 args=0x10 locals=0x10
	0x0000 00000 (pointervalue2.go:3)	TEXT	"".swap(SB), NOSPLIT, $16-16 //一个入参+返回值参数+局部变量+bp
	0x0000 00000 (pointervalue2.go:3)	SUBQ	$16, SP  //
	0x0004 00004 (pointervalue2.go:3)	MOVQ	BP, 8(SP)
	0x0009 00009 (pointervalue2.go:3)	LEAQ	8(SP), BP //暂存bp
	0x000e 00014 (pointervalue2.go:3)	FUNCDATA	$0, gclocals·f207267fbf96a0178e8758c6e3e0ce28(SB)
	0x000e 00014 (pointervalue2.go:3)	FUNCDATA	$1, gclocals·33cdeccccebe80329f1fdbee7f5874cb(SB)
	0x000e 00014 (pointervalue2.go:3)	MOVQ	$0, "".~r1+32(SP) //初始化返回值
	0x0017 00023 (pointervalue2.go:4)	MOVQ	"".x+24(SP), AX //将入参放入AX
	0x001c 00028 (pointervalue2.go:4)	MOVQ	AX, "".c(SP)  //将AX放入局部变量c
	0x0020 00032 (pointervalue2.go:5)	MOVQ	AX, "".~r1+32(SP) //将AX放入返回值
	0x0025 00037 (pointervalue2.go:5)	MOVQ	8(SP), BP //复原BP
	0x002a 00042 (pointervalue2.go:5)	ADDQ	$16, SP //复原SP
	0x002e 00046 (pointervalue2.go:5)	RET
	0x0000 48 83 ec 10 48 89 6c 24 08 48 8d 6c 24 08 48 c7  H...H.l$.H.l$.H.
	0x0010 44 24 20 00 00 00 00 48 8b 44 24 18 48 89 04 24  D$ ....H.D$.H..$
	0x0020 48 89 44 24 20 48 8b 6c 24 08 48 83 c4 10 c3     H.D$ H.l$.H....
...
go.info."".swap SDWARFINFO size=69
	0x0000 02 22 22 2e 73 77 61 70 00 00 00 00 00 00 00 00  ."".swap........
	0x0010 00 00 00 00 00 00 00 00 00 01 9c 00 00 00 00 01  ................
	0x0020 09 63 00 04 00 00 00 00 02 91 68 0e 78 00 00 03  .c........h.x...
	0x0030 00 00 00 00 01 9c 0e 7e 72 31 00 01 03 00 00 00  .......~r1......
	0x0040 00 02 91 08 00                                   .....
	rel 9+8 t=1 "".swap+0
	rel 17+8 t=1 "".swap+47
	rel 27+4 t=29 gofile../root/go/src/asm_learn/pointervalue2/pointervalue2.go+0
